...
#import "Masonry.h"
@interface ActivityAlterView ()
@property(nonatomic,strong) UIView *viewContent;
@property(nonatomic,strong) UIView *viewBg;
@end
@implementation ActivityAlterView
...
- (void)setQRimage:(UIImage *)QRimage
{
    ...
    //_viewContent.backgroundColor=[UIColor redColor];
    ...
    NSLog(@"%f",_viewBg.frame.size.width);
    
    
//    //顶部家芭莎image
    UIImageView *imageviewTop =[[UIImageView alloc]initWithFrame:CGRectMake(0, 0, 290, 407)];
    //imageviewTop.backgroundColor=[UIColor redColor];
    imageviewTop.image=_QRimage;
...
//    }];
    ...
    UIImageView *imageviewQrcode=[[UIImageView alloc]initWithFrame:CGRectMake(0, 0, _viewContent.frame.size.width, _viewContent.frame.size.height)];
    imageviewQrcode.backgroundColor=[UIColor redColor];
...
//        make.centerX.mas_equalTo(_viewContent.centerX);
//        make.top.mas_equalTo(_viewContent.mas_bottom).offset(10);
//    }];
