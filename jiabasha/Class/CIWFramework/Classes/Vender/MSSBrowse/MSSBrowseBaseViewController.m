...
- (void)createBrowseView
{
    ...
    _collectionView = [[UICollectionView alloc]initWithFrame:CGRectMake(0, 0, kScreenWidth + kBrowseSpace, kScreenHeight) collectionViewLayout:flowLayout];
    ...
    _collectionView.contentOffset = CGPointMake(_currentIndex * (kScreenWidth + kBrowseSpace), 0);
    [_bgView addSubview:_collectionView];
    
    _countLabel = [[UILabel alloc]init];
    _countLabel.textColor = [UIColor whiteColor];
    _countLabel.frame = CGRectMake(0, kScreenHeight - 50, kScreenWidth, 50);
...
- (UICollectionViewCell *)collectionView:(UICollectionView *)collectionView cellForItemAtIndexPath:(NSIndexPath *)indexPath
{
    ...
    {        
        ...
        // 还原初始缩放比例
        cell.zoomScrollView.frame = CGRectMake(0, 0, kScreenWidth, kScreenHeight);
        cell.zoomScrollView.zoomScale = 1.0f;
        // 将scrollview的contentSize还原成缩放前
        cell.zoomScrollView.contentSize = CGSizeMake(kScreenWidth, kScreenHeight);
...
{
    return CGSizeMake(kScreenWidth + kBrowseSpace, kScreenHeight);
}
...
- (void)scrollViewDidScroll:(UIScrollView *)scrollView
{
    if(!_isRotate)
    {
        _currentIndex = scrollView.contentOffset.x / (kScreenWidth + kBrowseSpace);
        _countLabel.text = [NSString stringWithFormat:@"%ld/%ld",(long)_currentIndex + 1,(long)_browseItemArray.count];
    }
    _isRotate = NO;
}
...
//            _screenHeight = MSS_SCREEN_WIDTH;
        ...
        _browseRemindView.frame = CGRectMake(0, 0, kScreenWidth, kScreenHeight);
        ...
        _collectionView.frame = CGRectMake(0, 0, kScreenWidth + kBrowseSpace, kScreenHeight);
        _collectionView.contentOffset = CGPointMake((kScreenWidth + kBrowseSpace) * _currentIndex, 0);
